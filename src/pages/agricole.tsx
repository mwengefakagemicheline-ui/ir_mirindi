...
const cultures = [
  ...
  },
  {
    ...
    conseils: ["Inoculation rhizobium", "Espacement 40×10 cm", "Éviter les excès d'eau"],
  ...
  },
  {
    ...
    conseils: ["Inoculation", "Labour profond 25 cm", "Récolte avant verse"],
    colSpan: "col-span-1 md:col-span-3",
  },
];
...
const conseils = [
  ...
  },
  {
    ...
    texte:
      "Arrosez tôt le matin pour réduire l'évaporation. Adoptez le goutte-à-goutte pour économiser jusquà 60 % d'eau. Évitez les excès qui favorisent les maladies fongiques.",
  },
  {
...
export function Agricole() {
  ...
  const faqs = [
    ...
    {
      q: "Quel rendement espérer pour le ma?s ?",
      ...
      <section className="relative h-screen min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <motion.div initial="hidden" animate="visible" className="max-w-3xl">
            ...
            >
              <span>●</span> Agriculture de précision
            </motion.div>
      ...
      <section id="cultures" className="py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-zinc-500 max-w-sm text-sm md:text-base leading-relaxed">
            Parcourez nos fiches cultures pour découvrir les meilleures pratiques adapt?es ? chaque variété, saison et type de sol.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-6 auto-rows-[350px]">
          {cultures.map((c, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={
                'relative overflow-hidden rounded-2xl group ' + c.colSpan
              }
            >
              <img
                src={c.image}
            ...
            {[
              {
                ...
                desc: "Cartographie de la fertilité pour des apports pr?cis et ?conomiques.",
              },
              {
                icon: <Sprout className="w-8 h-8 text-green-600" />,
                title: "Semences certifiées",
                desc: "S?lection de variétés ? haut potentiel de rendement et r?silientes.",
              },
              {
      ...
      <section className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <div key={i} className="group border-b border-zinc-200 pb-6">
                <button
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full flex items-start gap-6 text-left py-2 outline-none"
                >
                  <span className="text-[#4ade80] font-display font-bold text-xl mt-1 shrink-0">0{i + 1}</span>
                  <div className="flex-1">
                    <h3
                      className={
                        'text-xl font-display font-medium transition-colors ' +
                        (openFaq === i ? 'text-zinc-900' : 'text-zinc-700 group-hover:text-zinc-900')
                      }
                    >
                      {faq.q}
                    </h3>
                    ...
                    <AnimatePresence>
                      {openFaq === i && (
                        ...
                        >
                          <p className="text-zinc-500 leading-relaxed pr-8">{faq.r}</p>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </div>
                  <ChevronDown
                    className={
                      'w-6 h-6 shrink-0 transition-transform duration-500 mt-1 ' +
                      (openFaq === i ? 'rotate-180 text-zinc-900' : 'text-zinc-400 group-hover:text-zinc-600')
                    }
                  />
                </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-zinc-300 text-lg leading-relaxed mb-8 max-w-lg">
                Échangeons sur vos défis agronomiques. Nos experts vous accompagnent pour construire un itinéraire technique performant.
              </p>

              <ul className="space-y-3 text-sm text-zinc-200/90 leading-relaxed mb-12">
                <li>• Consultation et diagnostic agronomique.</li>
                <li>• Orientations à l'ouverture de projet agricole.</li>
                <li>• Accompagnement complet des porteurs de projet.</li>
                <li>• Vente de produits agricoles : cacao, tomate, pastèque, maïs, oignon, et autres produits.</li>
              </ul>
                ...
                {[
                  {
                    ...
                    label: "Notre agence",
                    value: "République démocratique du Congo, Minova centre commercial, en face de l’hôtel Luna",
                  },
