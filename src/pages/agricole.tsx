...
const cultures = [
  ...
  },
  {
    ...
    conseils: ["Inoculation rhizobium", "Espacement 40×10 cm", "Éviter excès d'eau"],
...
const conseils = [
  ...
  },
  {
    ...
    texte: "Arrosez tôt le matin pour réduire l'évaporation. Adoptez le goutte-à-goutte pour économiser jusqu'à 60 % d'eau. Évitez les excès qui favorisent les maladies fongiques.",
  },
  {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  { icon: <MapPin className="w-6 h-6" />, label: "Notre agence", value: "République démocratique du Congo, Minova centre commercial, en face de l’hôtel Luna" },
